---
title: "Resources"
description: "Curated K-12 computing resources — the CRAFT PD toolkit (AI-integration templates, verification tools, micro:bit/IoT starters), standards-aligned video PD, and vetted external STEM resources."
type: "page"
---
...
Classroom-ready artifacts from the **CRAFT PD Series** (Contextualize → Reframe → Assemble → Fortify → Transfer). Organized by what you want to do, not by which workshop they came from.

### Teach with AI

Help students use generative AI as a partner for STEM learning — with guardrails that make the thinking visible.
...
Move students from AI on a screen to AI on a sensor — build, measure, and reason about the physical world.
...
Background reading and overview materials — use these when introducing the CRAFT cycle to colleagues or administrators.
...
<div class="card-grid">
  ...
  <div class="card">
    ...
    <p class="card-desc">Interactive map of 378 lessons across CSTA, CCSS-Math, CCSS-ELA, NGSS, ISTE, C3, National Core Arts, and ITEEA STEL standards. Includes a quick-start guide.</p>
