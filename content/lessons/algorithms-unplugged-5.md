...
description: Students will be learning how to create an algorithm/sequence by giving
  ...
  a room with tile floors to map out 7x7 areas. They may work in groups and take turns
  giving directions to their 'bot' and rotate bots as they reach their destination.
...
materials: Graph paper, marker, sticky notes, gym with tile floor/hall
---
# OVERVIEW
## Activity Overview:  
Students will be learning how to create an algorithm/sequence by giving set directions to their 'bot' (another student) to go to a specific location inside a room with tile floors to map out 7x7 areas. They may work in groups and take turns giving directions to their 'bot' and rotate bots as they reach their destination.
## Meta description
+ *Subject Area:* Computer Science, Mathematics, Reading/Language Arts, Speaking and Listening 
+ *Grade Level :* K-2, 3-5 
...
+ *Materials:* 
   + Graph paper, marker, sticky notes, gym with tile floor/hall
+ *Considerations:*
   + N/A
