...
| Other Content Standards | [8.AP.A.01](https://edu.wyoming.gov/educators/standards/computer-science/) - Create flowcharts and pseudocode to design algorithms to solve complex problems. [8.AP.M.01](https://edu.wyoming.gov/educators/standards/computer-science/) - Using grade appropriate content and complexity, decompose problems and sub-problems into parts to facilitate the design, implementation, and review of programs. [8.AP.M.02](https://edu.wyoming.gov/educators/standards/computer-science/) - Using grade appropriate content and complexity, create procedures with parameters to organize code and make it easier to reuse. [8.AP.PD.03](https://edu.wyoming.gov/educators/standards/computer-science/) - Systematically test and refine programs using a range of test cases. [8.AP.PD.04](https://edu.wyoming.gov/educators/standards/computer-science/) - Using grade appropriate content and complexity, document programs in order to make them easier to follow, test, and debug.  |