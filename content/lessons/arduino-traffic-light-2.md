...
description: Students will code an Arduino traffic light code. They will then build an Arduino traffic light simulator. They will then change timings for their variables
date: '2023-07-27'
draft: false
...
## OBJECTIVES
I can write a code for a traffic light simulator.
I can build a traffic light simulator
I can test my code using my simulator.
