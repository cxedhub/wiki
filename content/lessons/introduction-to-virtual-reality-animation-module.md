...
- WySTACK
supplements:
- /uploads/introduction-to-virtual-reality-animation-module/IMG_4770_-_Stephanie_May.MOV
- /uploads/introduction-to-virtual-reality-animation-module/IMG_4773_-_Stephanie_May.MOV
- /uploads/introduction-to-virtual-reality-animation-module/IMG_4775_-_Stephanie_May.jpg
...
Cause the shape to spin
## OBJECTIVES
Use animations to move and rotate shapes
...
Students will work through each of the following activities:
3.1.1 Check for Understanding: Animation Tag
3.1.2 Quiz: Animation Tag
3.1.3 Example: Cube Sliding
3.1.4 Example: Ball Drop
3.1.5 Exercise: Sliding Cylinder
3.1.6 Video: What Can We Animate?
3.1.7 Check for Understanding: What Can We Animate?
3.1.8 Example: Rolling Ball
3.1.9 Example: Types of Animation
3.1.10 Exercise: Radioactive
3.1.11 Video: How Can We Animate?
3.1.12 Check for Understanding: How Can We Animate?
3.1.13 Example: Starburst
3.1.14 Exercise: Wormhole
3.1.15 Exercise: Catapult
3.1.16 Exercise: Light Speed Ahead!
3.1.17 Notes: Advanced Options
3.1.18 Example: Starburst on a Timer
3.1.19 Challenge: Animate a Scene!
3.1.20 Badge: Animation Badge
