...
materials: Website, www.johnlupher.com
tags:
- WySTACK
- micro:bit
standard_types:
...
How does Python recognize data that is to be as bytes?
What are ordinal values?
Is there a different decimal value for a uppercase A and a lowercase a? If so how can I find the values in Python?
## OBJECTIVES
Convert data into hexadecimal format.
Convert data in to binary format.
Display the ordinal value of ASCII data.
